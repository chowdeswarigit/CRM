...
function Dashboard() {
  ...
  return (
    ...
    style={{ cursor: cursor }} className='dashboard-container'>
        ...
        <div className="header-container">
            ...
            <div className="nav-container">
              ...
              <img
                ...
                onClick={() => navigate("/")}
              />
              <div className='menu' style={{marginLeft:"30px"}}>
              {isUser &&  <select className='selectMenu' onClick={(e)=> setselectValue(e.target.value)}>
                <option></option>
            ...
            <div className="mobile-header-navbar-container">
              ...
              >
                <ul className="mobile-hamburger-menu">
                  <li className="header-navbar-link" onClick={() => handleDashboard()}>Dashboard </li>
      ...
      {isUser &&   <AllUsers selectValue  ={selectValue}/>}
